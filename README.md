About xarray-topo-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xarray-topo-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4396&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xarray-topo-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xarray-topo` can be installed with `conda`:
...
```
mamba install xarray-topo
```

It is possible to list all of the versions of `xarray-topo` available on your platform with `conda`:
...
```
mamba search xarray-topo --channel conda-forge
```
...
mamba repoquery search xarray-topo --channel conda-forge

# List packages depending on `xarray-topo`:
mamba repoquery whoneeds xarray-topo --channel conda-forge

# List dependencies of `xarray-topo`:
mamba repoquery depends xarray-topo --channel conda-forge
```
